...
Команда `/UAH` показує або змінює курс UAH до USDT.

```text
/UAH 43.5
```

Команда `/usdt` показує, змінює або оновлює внутрішній курс FunPay.
...
Покупки відображаються в UAH без комісії. Баланс у `/profile` показується в UAH з урахуванням комісії виводу.
