...
Модифікована збірка FunPay Cardinal Remake для автоматизації роботи з FunPay.

У цій версії прибрані рекламні інтеграції, віддалені оголошення, автозавантаження оновлень і автоматична зміна профілю Telegram-бота. Інтерфейс бота залишено тільки українською мовою, а всі суми для користувача показуються в гривнях.
...
- Профіль, сповіщення, покупки та ручний вивід показуються в гривнях.
...
Бот показує суми в гривнях через прямий курс FunPay.
Курс автоматично оновлюється кожні 180 хвилин.

Покупки, баланс у `/profile` і ручний вивід відображаються прямим перерахунком у гривні.
