...
В этой сборке удалены рекламные интеграции, удаленные объявления, автозагрузка обновлений и автоматическое изменение профиля Telegram-бота.
...
Перед запуском не публикуйте и не передавайте другим людям:
