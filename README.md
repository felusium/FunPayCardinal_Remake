...
Модифицированная версия FunPay Cardinal Remake для автоматизации работы с FunPay.

В этой сборке удалены рекламные интеграции, удаленные объявления, автозагрузка обновлений и автоматическое изменение профиля Telegram-бота. Обновления устанавливаются только вручную.
