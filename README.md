...
Бот показує суми в гривнях через прямий курс FunPay з виводу на банківську карту UA.
Наприклад, якщо FunPay показує `курс 0.543`, то `4674.86 ₽` рахується як `4674.86 × 0.543`.
Курс автоматично оновлюється кожні 180 хвилин, а вручну його можна перевірити або змінити командою `/UAH`.
...
Покупки, баланс у `/profile` і ручний вивід відображаються прямим перерахунком у гривні без додаткової 6% комісії в боті.
