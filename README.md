<h1 align="center">FunPay Cardinal Remake</h1>
...
- **Оптимизация**. _100 МБ свободного места на диске, до 200 МБ ОЗУ, доступ в интернет_ - все что нужно для работы.
...
2. Скачайте [FunPay Cardinal](https:///archive/refs/heads/master.zip)
3. Перенесите архив `FunPayCardinal Remake-main.zip` в нужное Вам место и распакуйте его.
4. Перейдите в папку `FunPayCardinal Remake-main`.
...
1. Выполните команду:
   Автоматическая загрузка установочного скрипта отключена. Обновляйте и устанавливайте файлы вручную.
