...
access_granted = "🔓 Доступ к ПУ предоставлен!\n\n" \
                 ...
                 "⚙️ Чтобы открыть меню настроек <i>FunPayCardinalRemake</i>, введи команду /menu."
...
update_lasted = "✅ У тебя стоит последняя версия FunPayCardinalRemake {}"
...
withdraw_amount_error = "❌ Неверная сумма. Введи сумму в гривнах, например <code>1000</code>, или <code>all</code> для всего доступного баланса."
