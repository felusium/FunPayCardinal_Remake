...
withdraw_amount_error = "❌ Invalid amount. Enter the amount in UAH, for example <code>1000</code>, or <code>all</code> for the full available balance."
withdraw_not_enough_balance = "❌ Not enough available balance. Currently available: <code>{} ₴</code>."
...
v_order_price = "<code>$order_price</code> - order amount."
