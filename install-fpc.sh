...
echo -e "\n\n${RED} * GitHub ${CYAN}${RESET}"
echo -e "${RED} * Telegram ${CYAN}${RESET}"
echo -e "\n\n\n"
...
echo -e "${start_process_line}\nАвтоматическая загрузка релизов отключена. Устанавливай обновления вручную.\n${end_process_line}"
exit 2
...
clear
echo -e $logo
echo -e '\n\n\e[1;91m * GitHub \e[1;96m\e[0m'
echo -e '\e[1;91m * Telegram \e[1;96m\e[0m'
